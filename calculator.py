...
sub = Button(ui,activebackground='#ffe46b', bg="#d0c6f5", text="-", padx=17, pady=15, command=lambda: substraction("-")).grid(row=5, column=3)
...
div = Button(ui,activebackground='#ffe46b', bg="#d0c6f5", text="/", padx=17, pady=8, command=lambda: division("/")).grid(row=3, column=3)
...
b0 = Button(ui,activebackground='#73f5d7', bg="#f5f0f0", text="0", padx=48, pady=15, command=lambda: insrt("0")).grid(row=7, column=0, columnspan=2)
